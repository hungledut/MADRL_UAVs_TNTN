...
if __name__ == '__main__':
    ...
    policy_net0 = DQN(207, 5).to(device)
    target_net0 = DQN(207, 5).to(device)

    policy_net1 = DQN(207, 5).to(device)
    target_net1 = DQN(207, 5).to(device)

    policy_net2 = DQN(207, 5).to(device)
    target_net2 = DQN(207, 5).to(device)
